...
public class LocalDeclarations extends LocalVarDeclList {

    private LocalVarDeclList LocalVarDeclList;
    private VarDecl VarDecl;

    public LocalDeclarations (LocalVarDeclList LocalVarDeclList, VarDecl VarDecl) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("LocalDeclarations(\n");
